...
namespace YMCA
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                // Подгружаем схему
                List<EncryptionSchema> schemas = EncryptionSchema.LoadSchemasFromJson(@"C:\Users\vladi\OneDrive\Документы\Курсовая ОП ОП\YMCA\YMCA\Resources\algorithms.json");
